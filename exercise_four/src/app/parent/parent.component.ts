...
export class ParentComponent {
  musicList: Music[] = [
    { id: 1, title: 'Backstreet Freestyle', artist: 'Kendrick Lamar', genre: 'Hip-Hop', releaseYear: 2012 },
    { id: 2, title: 'Only Ones Who Know', artist: 'Arctic Monkeys', genre: 'Alternative', releaseYear: 2007 },
    { id: 1, title: 'Wicked Games', artist: 'The Weeknd', genre: 'R&B', releaseYear: 2011 },
  ];
